...
public class listenersVtiger extends VtigerBaseClass implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
	   ...
	   File to = new File(".\\src\\test\\resources\\ScreenshotVtiger"+name+time+".png");
	   try {
	...
	public void onStart(ITestContext context) {
		...
		File path=new File(".\\src\\test\\resources\\Report\\SingleReportVtiger.html");
